...
class HDFSContentsManager(ContentsManager, HDFSManagerMixin):
    ...
    hdfs_namenode_host = Unicode(u'local-host', config=True, help='The HDFS namenode host')
    hdfs_namenode_port = Integer(9090, config=True, help='The HDFS namenode port')
